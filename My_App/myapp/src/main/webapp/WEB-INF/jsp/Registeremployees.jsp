...
<div class="container">
        ...
        <c:if test = "${not empty employeeModel.inputErrors['successMessage']}">
                    <div class="alert alert-success" role ="alert">
                         <strong>${employeeModel.inputErrors['successMessage']}</strong>
                    </div>
        </c:if>
...
<form id = "FormPerson" class="form-group" name="form" method="post" action="<c:url value="/employees/register" />">
		...
		<div class="form-group">
  		...
  		<a href="<c:url value="/employees/" />"  role="button" class ="btn pull-left" aria-pressed="true">Employee List</a>
  </form>
  <br>
